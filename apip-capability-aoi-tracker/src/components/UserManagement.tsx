...
import { UserPlus, Trash2, Shield, User as UserIcon, X, Plus, Edit3 } from 'lucide-react';
          ...
          >
            ...
            <div className="mt-4 pt-4 border-t border-slate-50 flex justify-between items-center">
              <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border ${
                ...
                user.role.startsWith('user-e') ? 'bg-amber-50 border-amber-100 text-amber-600' :
            ...
            >
              <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                <h3 className="font-black text-slate-800 uppercase tracking-tight italic">
                  {editingUser ? 'Perbarui Akun Pengguna' : 'Registrasi Akun Baru'}
                </h3>
              ...
              <form onSubmit={handleSubmitUser} className="p-8 space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all font-medium"
                  />
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5 pt-2">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-sm focus:outline-none focus:border-blue-600 transition-all font-bold"
                  >
                    <optgroup label="General Roles">
                      <option value="user">User - All Elements</option>
                      <option value="admin">Admin - Full Access</option>
                    </optgroup>
                    <optgroup label="Element Specific Roles">
                      <option value="user-e1">User Elemen 1</option>
                      <option value="user-e2">User Elemen 2</option>
                      <option value="user-e3">User Elemen 3</option>
                      <option value="user-e4">User Elemen 4</option>
                      <option value="user-e5">User Elemen 5</option>
                    </optgroup>
                  </select>
                </div>
                <button
                ...
                >
                  {editingUser ? 'Update User Account' : 'Confirm & Create Account'}
                </button>
              </form>
            </motion.div>
          </div>
